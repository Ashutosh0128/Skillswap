...
if USE_MYSQL:
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='skillswap_db'),
...
# 4. Set EMAIL_HOST_PASSWORD=your-16-digit-app-password

# Anthropic AI Configuration
ANTHROPIC_API_KEY = config('ANTHROPIC_API_KEY', default='')

# AI Model Settings
AI_MODEL = config('AI_MODEL', default='claude-3-sonnet-20241022')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'skillswap.log',
            'formatter': 'verbose',
        },
    },
    'root': {
...
SITE_ID = 1
SITE_NAME = 'SkillSwap'
SITE_DESCRIPTION = 'Peer-to-Peer Skill Sharing Platform'
...
# Stripe Payment Configuration (For future implementation)
...
ADMIN_NAME = config('ADMIN_NAME', default='SkillSwap Admin')
ADMIN_EMAIL = config('ADMIN_EMAIL', default='admin@skillswap.com')
